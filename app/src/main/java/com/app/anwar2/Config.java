...
public class Config {
    ...
    public static final Object[] TITLES = new Object[]{"Anwar Hidayat Apps"};
    //The URL's of your web items
    public static final String[] URLS = new String[]{"https://apps.dedeanwarhidayat.com/web/"};
    ...
    public static String ANALYTICS_ID = "UA-106787533-1";
